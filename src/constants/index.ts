...
export const WorkExperiences = [
  {
    ...
    jobdesks: [
      ...
      "Compile a list of data on goods and prices for materials, consumables and media",
      "Contacting and Negotiating with Suppliers to Purchase Goods",
      "Contacting Customers About Work in the Field",
      "Create Delivery Notes for Materials, Consumables, and Tools",
      "Create Manpower Work Schedules",
      "Create Monthly Reports on Purchases of Materials, Tools and Consumables",
      "Create a Daily Project Overtime Forms",
      "Create Project Completion Minutes",
      "Providing Tools/Materials Offers to Customers"
    ],
    images: [
