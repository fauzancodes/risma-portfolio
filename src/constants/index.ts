...
export const WorkExperiences = [
  {
    ...
    description: "I have experience working at PT Krida Hangulindo Utama from August 18, 2020, to January 31, 2024, holding the position as a Project Administrator and a Purchasing Administrator. The Company operates in the construction/pipe installation field for wastewater treatment (WWTP/WTP), located in East Cikarang, West Java.",
    jobdesks: [
      "Creating Daily Reports, Weekly Reports and Monthly Project Reports",
      "Creating Purchase Requests and Purchase Orders for Materials and Consumables",
      "Compiling a Data List of Items and Prices for Materials, Consumbales, and Media",
      "Contacting and Negotiating with Suppliers for Purchasing Goods",
      "Contacting Customers Regarding Fieldwork",
      "Generating Material, Consumable, and Tool Delivery Notes",
      "Creating Manpower Work Schedules",
      "Generating Monthly Reports on Material, Tool and Consumable Purchases",
