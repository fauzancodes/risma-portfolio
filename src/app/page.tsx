          ...
          <div className="tw-border-t-0 tw-border-r tw-border-l-0 tw-border-b tw-border-dark tw-border-solid tw-w-10 tw-h-10 md:tw-w-36 md:tw-h-36"></div>
			...
			<section id="list-of-content" className={`tw-bg-secondary-light tw-min-h-screen tw-flex tw-items-center tw-flex-row tw-justify-between tw-flex-wrap tw-relative`}>
				...
				<div className={`${FlexCenterX} tw-flex-col tw-bg-primary tw-w-full md:tw-w-6/12 tw-text-2xl tw-font-bold md:tw-text-4xl md:tw-min-h-screen tw-px-10 tw-pb-20 md:tw-pb-0`}>
					<a href="#cover" className={`${FlexCenterY} !tw-my-5 tw-no-underline tw-text-dark hover:tw-text-accent tw-gap-3`}>01 Cover <FaArrowRight /></a>
					<a href="#list-of-content" className={`${FlexCenterY} !tw-my-5 tw-no-underline tw-text-dark hover:tw-text-accent tw-gap-3`}>02 List Of Contents <FaArrowRight /></a>
					<a href="/about-me" className={`${FlexCenterY} !tw-my-5 tw-no-underline tw-text-dark hover:tw-text-accent tw-gap-3`}>03 About Me <FaArrowRight /></a>
					<a href="/education" className={`${FlexCenterY} !tw-my-5 tw-no-underline tw-text-dark hover:tw-text-accent tw-gap-3`}>04 Education <FaArrowRight /></a>
					<a href="/certification" className={`${FlexCenterY} !tw-my-5 tw-no-underline tw-text-dark hover:tw-text-accent tw-gap-3`}>05 Certification <FaArrowRight /></a>
					<a href="/project-portfolio" className={`${FlexCenterY} !tw-my-5 tw-no-underline tw-text-dark hover:tw-text-accent tw-gap-3`}>06 Project Portfolio <FaArrowRight /></a>
					<a href="/contact" className={`${FlexCenterY} !tw-my-5 tw-no-underline tw-text-dark hover:tw-text-accent tw-gap-3`}>07 Contact <FaArrowRight /></a>
				</div>
